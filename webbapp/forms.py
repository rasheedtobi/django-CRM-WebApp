...
class AddRecordForm(forms.ModelForm):
    ...
    phone_no = forms.IntegerField(required=True, widget=forms.widgets.TextInput(
    ...
    zip_code = forms.IntegerField(required=True, widget=forms.widgets.TextInput(
    ...
    country = forms.CharField(required=True, widget=forms.widgets.TextInput(
        attrs={"placeholder": "Country", "class": "form-control"}), label="")
